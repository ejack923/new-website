...
export default function RGAPortal() {
  ...
  const iframeSrc = `https://portal.completelawsupport.com${currentPath}${currentSearch}${currentSearch ? '&' : '?'}back=https://completelawsupport.com/rga-portal`;
  ...
  return (
    ...
    >
      ...
      {/* Embed RGA Portal Tools Dashboard */}
