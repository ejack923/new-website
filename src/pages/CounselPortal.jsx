...
export default function CounselPortal() {
  ...
  const iframeSrc = `https://portal.completelawsupport.com${currentPath}${currentSearch}${currentSearch ? '&' : '?'}back=https://completelawsupport.com/counsel-portal`;
  ...
  return (
    ...
    >
      ...
      {/* Embed Counsel Portal Tools Dashboard */}
